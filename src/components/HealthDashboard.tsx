...
export const HealthDashboard: React.FC<HealthDashboardProps> = ({
  ...
  return (
    <div
      className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 animate-fade-in overflow-y-auto"
      style={{
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm font-medium">
            {Math.round(
              healthData.distance.current / healthData.distance.goal * 100
            )}
            %
          </span>
        </div>
