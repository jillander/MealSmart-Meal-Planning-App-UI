...
import { ArrowLeftIcon, BookmarkIcon, ClockIcon, BarChartIcon, DumbbellIcon, PlayIcon, CheckIcon, XIcon } from 'lucide-react';
...
export const RecipeDetailScreen: React.FC<RecipeDetailScreenProps> = ({
  ...
  return <div className="flex flex-col min-h-screen bg-[#FFE8D6]">
      {/* Status Bar */}
      ...
      <div className="relative w-full h-64">
        <img src="https://images.unsplash.com/photo-1565299585323-38d6b0865b47?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2000&q=80" alt="One-Pan Chicken Dinner" className="w-full h-full object-cover" />
        <div className="absolute top-0 left-0 right-0 p-4 flex justify-between">
          <button className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md" onClick={() => navigateTo('home')}>
      ...
      <div className="flex-1 bg-[#FFF9F2] rounded-t-3xl -mt-6 px-6 py-6 overflow-y-auto">
        ...
        <button className="w-full bg-[#FF6B6B] text-white py-4 px-6 rounded-full font-medium text-lg shadow-sm hover:bg-opacity-90 transition-colors" onClick={onMarkAsPrepared}>
          Mark as Prepared
        </button>
      </div>
    </div>;
