  ...
  return (
    <div
      ...
      <div className="flex items-center">
        ...
        {isComplete ?
        <button
          className="flex items-center bg-[#4CAF50]/10 text-[#4CAF50] px-3 py-1 rounded-full text-xs font-medium"
          onClick={(e) => {
            e.stopPropagation();
            onClick();
          }}>
        ...
        <div className="w-16">
            <div className="relative h-1 bg-gray-200 rounded-full overflow-hidden">
              <div
              className="absolute h-full bg-[#4CAF50] rounded-full transition-all duration-300"
              style={{
                width: `${progress}%`
              }} />
