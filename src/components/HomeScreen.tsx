                ...
                return (
                  <div key={mealType}>
                      ...
                      <div className="space-y-3 animate-fade-in">
                          ...
                          className="flex w-full items-center gap-3 rounded-2xl bg-[#1A1A1A] p-4 text-left transition-colors hover:bg-[#2A2A2A] active:scale-[0.99]">
                              ...
                              <span className="min-w-0">
                                ...
                                <span className="mt-0.5 block text-xs text-white/60">
                                  Photograph what you ate — we&rsquo;ll do the maths
                                </span>
                              </span>
                            </button>
